...
if (!$id && $method === 'GET') {
    try {
        ...
        logApiError('Error fetching users list', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
        ]);
...
if ($id === 'me' && $method === 'GET') {
    try {
        ...
        logApiError('Error fetching user profile', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
...
if ($id === 'me' && $sub === 'avatar' && $method === 'DELETE') {
    try {
        ...
        logApiError('Error deleting avatar', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'user_id' => $user['id'] ?? null,
        ]);
        jsonResponse(['error' => 'Failed to delete avatar'], 500);
    }
}
...
if ($id === 'me' && $method === 'PUT') {
    try {
        ...
        logApiError('Error updating profile', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'user_id' => $user['id'] ?? null,
...
if ($id === 'me' && $sub === 'skills' && $method === 'GET') {
    try {
        ...
        logApiError('Error fetching user skills', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'user_id' => $user['id'] ?? null,
...
if ($id === 'me' && $sub === 'skills' && $method === 'POST') {
    try {
        ...
        logApiError('Error adding/updating user skill (non-DB)', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'user_id' => $user['id'] ?? null,
        ]);
        jsonResponse(['error' => 'Failed to add skill'], 500);
    }
}
...
if ($id === 'me' && $sub === 'skills' && $method === 'DELETE' && $subId) {
    try {
        ...
        logApiError('Error deleting user skill', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'user_id' => $user['id'] ?? null,
        ...
        jsonResponse(['error' => 'Failed to remove skill'], 500);
    }
}
...
if ($id === 'search' && $method === 'GET') {
    try {
        ...
        logApiError('Error searching users', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'teach_skill' => $teachSkill ?? null,
            'learn_skill' => $learnSkill ?? null,
        ]);
...
if (is_numeric($id) && $sub === 'completed-calls-count' && $method === 'GET') {
    try {
        ...
        logApiError('Error fetching completed calls count', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'user_id' => $userId ?? null,
        ]);
        jsonResponse(['error' => 'Failed to fetch calls count'], 500);
    }
}
...
if (is_numeric($id) && !$sub && $method === 'GET') {
    try {
        ...
        logApiError('Error fetching user public profile', [
            'error' => $e->getMessage(),
            'file' => $e->getFile(),
            'line' => $e->getLine(),
            'user_id' => $userId ?? null,
